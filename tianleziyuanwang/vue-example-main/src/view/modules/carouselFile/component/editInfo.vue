...
<template>
    <div id="app">
      <el-drawer
        ...
        <el-form-item label="设置字体颜色">
          ...
          &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;
          <el-button @click="pickColor" plain v-if="false">吸管工具</el-button>
          </div>
        ...
        <!-- <el-form-item label="上传文件">
          <el-upload class="upload-demo" action="#" drag ref="upload" :headers="getHeaders()"
            ...
            :file-list="fileList" :auto-upload="false" :show-file-list="true" multiple :accept="'.png,.jpg'">
            <i class="el-icon-upload"></i>
            <div class="el-upload__text">将文件拖到此处，或<em>点击上传</em></div>
          </el-upload>
        </el-form-item> -->
        <el-form-item>
          <button type="button" style="width: 75%;" class="btn btn-primary"
            @click="updateCarouseFileInfo()">Submit</button>
        </el-form-item>
      </el-form>
        <!-- <div>
            <br>
            ...
            <!-- <div style="display: flex; justify-content: center; align-items: center;">
              <button type="button" style="width: 75%;" class="btn btn-primary" @click="updateCarouseFileInfo()">Update</button>
            </div>
        </div> -->
      </el-drawer>
    </div>
  ...
  import { carouselEdit , carouselDelet } from '@/api/carousel_file.js'
  ...
  export default {
    ...
    methods: {
      ...
      //修改轮播图信息
      async updateCarouseFileInfo(){
        let params = {
            "id": this.carouselFileId,
            "soft": this.sort,
