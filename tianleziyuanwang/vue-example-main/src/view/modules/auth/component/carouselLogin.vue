<!--
 * @Author: tianleiyu 
 * @Date: 2024-03-25 15:02:47
 * @LastEditTime: 2024-03-26 15:23:52
 * @LastEditors: tianleiyu
 * @Description: 
 * @FilePath: /vue-example-main/src/view/modules/auth/component/carouselLogin.vue
    ...
    methods: {
      ...
      async loginService() {
          ...
          if (result.data.code == "0x200") {
            ...
            this.$cookie.set('logintype', 'carouselLogin');
