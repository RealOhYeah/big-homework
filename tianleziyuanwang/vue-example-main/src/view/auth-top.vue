 ...
 * @LastEditTime: 2024-04-17 16:57:50
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white">
                <div class="container">
                    ...
                    <a class="navbar-brand"  href="/h">
                        <img alt="Image placeholder" style="height:3.4rem" src="../assets/gs_xy_logo.png" id="navbar-logo">
                    </a>
                    <!-- Toggler -->
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <ul class="navbar-nav mt-4 mt-lg-0 ml-auto">
                            ...
                            <li class="nav-item " v-if="file">
                                <a @click.prevent="FileSystem" class="nav-link" href=""  >文件管理</a>
                            </li>
                            
                            <li class="nav-item " v-if="carousel">
                                <a @click.prevent="goCarousel" class="nav-link" href=""  >轮播图通道</a>
                            </li>

                            <li class="nav-item ">
                                <a @click.prevent="accountOut" class="nav-link" href=""  >退出账号</a>
                            </li> <!-- *1*绑定一个点击事件，*2*点击后清除里面的数据 本地的token，跳转到登陆页面this.$router.push('登录地址名：router——/auth') -->
